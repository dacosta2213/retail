frappe.pages['dashboard-retail'].on_page_load = function(wrapper) {
...
frappe.Inicio = Class.extend({
  ...
  get_clientes: function ($container, start=0) {
    ...
    frappe.call({
      method: "retail.retail.page.dashboard_retail.dashboard_retail.get_clientes",
      args: {
        doctype: "Customer",
        timespan: "Year",
        field: "total_amount",
